...
class FavoritesViewController: UIViewController {
    ...
    func getData(){
        ...
        AF.request("http://34.123.226.60:8080/auth/favorite/user/1", method: .get, headers: headers).responseJSON(completionHandler: { [weak self] response in
            do{
...
extension FavoritesViewController:  UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.tableView.dequeueReusableCell(withIdentifier: "favoritesCell") as! FavoritesTableViewCell
